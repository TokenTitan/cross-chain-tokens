...
contract MailboxMock {
    ...
    mapping(uint32 => MailboxMock) public remoteMailboxes;
    ...
    function addRemoteMailbox(uint32 _domain, MailboxMock _mailbox) external {
    ...
    function dispatch(
        ...
        MailboxMock _destinationMailbox = remoteMailboxes[_destinationDomain];
        require(
